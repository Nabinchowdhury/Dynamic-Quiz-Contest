...
const Blog = () => {
    return (
        <div className='my-12'>
            <div className='border w-3/4 mx-auto rounded-lg bg-slate-100 font-bold p-3 mb-10'>
            ...
            <div className='border w-3/4 mx-auto rounded-lg bg-slate-100 font-bold p-3'>
